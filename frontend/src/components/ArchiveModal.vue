          ...
          >
            <div class="item-info">
              ...
              <div class="item-timestamps">
                <span v-if="task.completed_at" class="timestamp completed" :title="new Date(task.completed_at).toLocaleString()">
                  Completed {{ formatTimestamp(task.completed_at) }}
                </span>
                <span v-if="task.archived_at" class="timestamp archived" :title="new Date(task.archived_at).toLocaleString()">
